...
$string['ai_analysing'] = 'Analysing content...';
$string['ai_apply_selected'] = 'Apply selected';
$string['ai_back'] = 'Back';
$string['ai_button'] = 'AI suggest';
$string['ai_comp_enabled'] = 'Enable {$a}';
$string['ai_dialogtitle'] = 'Suggestions';
$string['ai_enabled'] = 'Enable AI suggest';
$string['ai_enabled_desc'] = 'Show the AI Suggest button in the C4L Author modal. When disabled, the button is hidden and no AI analysis is available.';
$string['ai_error'] = 'AI classification failed: {$a}.';
$string['ai_guard_already_analysed'] = 'This content has already been analysed.';
$string['ai_guard_saturated'] = 'The document already has enough C4L components.';
$string['ai_guard_too_short'] = 'The document needs at least 3 paragraphs to analyse.';
$string['ai_label_attention'] = 'Attention';
$string['ai_label_keyconcept'] = 'Key concept';
$string['ai_label_learning_outcomes'] = 'Learning outcomes';
$string['ai_label_reminder'] = 'Reminder';
$string['ai_label_tip'] = 'Tip';
$string['ai_learning_outcomes_title'] = 'Learning outcomes';
$string['ai_maxrate'] = '{$a}: max per 10 paragraphs';
$string['ai_maxrate_desc'] = 'Maximum suggestions of this component type per 10 paragraphs.';
$string['ai_min_suggestions'] = 'Minimum suggestions';
$string['ai_min_suggestions_desc'] = 'Minimum number of AI suggestions returned. When the content has more paragraphs than this value, the limit equals the number of paragraphs instead.';
$string['ai_no_provider'] = 'No AI provider is configured. Please configure a provider in Site administration > AI.';
$string['ai_parse_error'] = 'Could not parse AI response. Please try again.';
$string['ai_prompt_extra'] = 'AI prompt extension';
$string['ai_prompt_extra_desc'] = '<div class="alert alert-warning"><strong>Warning:</strong> This field is intended for adding custom component definitions to the AI classification prompt. Modifying this content may alter the AI behaviour in unexpected ways. <strong>Correct operation of the AI Suggest feature is not guaranteed</strong> if this field is changed.</div>Use this field to describe additional component types that the AI should recognise. For example:<br><code>- <strong>mycomponent</strong>: A brief description of when this component should be suggested.</code>';
$string['ai_reanalyse'] = 'Re-analyse';
$string['ai_redo'] = 'Redo';
$string['ai_selected_count'] = 'suggestions selected';
$string['ai_settings'] = 'AI suggest';
$string['ai_settings_desc'] = 'Configure the AI-based component suggestion feature. When enabled, a button appears in the editor modal header allowing the user to analyse content and receive C4L component suggestions.';
$string['ai_undo_hint'] = 'No changes until you click Apply.';
...
$string['code_apply'] = 'Apply code';
$string['code_back'] = 'Back';
$string['code_button'] = 'Code';
$string['comfort-reading'] = 'Comfort reading';
$string['conceptreview'] = 'Concept review';
$string['contextual'] = 'Contextual';
$string['convert_nocomponent'] = 'No component to convert';
$string['convert_notconvertible'] = 'This component is not convertible';
...
$string['discardclose'] = 'Close without applying changes';
$string['discardconfirm'] = 'You have unsaved changes. Are you sure you want to close the editor? Your changes will be lost.';
...
$string['docs_assessment_desc'] = 'Assessment section for complex tasks.';
...
$string['docs_statement_desc'] = 'Statement section for complex tasks.';
...
$string['enabledocs'] = 'Enable docs tooltips';
$string['enabledocs_desc'] = 'If enabled, hovering over a component in the sidebar for 2 seconds shows a tooltip with its description and use cases.';
...
$string['overlay_openmask'] = 'Click to open the C4L Author editor';
$string['overlay_openmask_restore'] = 'Show the original editor';
$string['overlay_openmask_save'] = 'Make sure to save before leaving the page';
$string['pluginname'] = 'C4L Author';
...
$string['setting_showoverlay'] = 'Show overlay';
$string['setting_showoverlay_desc'] = 'When enabled, a clickable overlay is displayed on top of the TinyMCE editor. Clicking it opens the C4L Author modal. The overlay can be dismissed to access the original editor.';
