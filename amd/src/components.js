...
const components = [
    ...
    },
    {
        ...
        code:
            ...
            aria-label="{{#estimatedtime}}">{{PLACEHOLDER}} <span>{{#min}}</span></div></div><p class="c4l-spacer">&nbsp;</p>`,
        text: "15",
        docs: {
    ...
    },
    {
        ...
        code:
            ...
            aria-label="{{#duedate}}">{{PLACEHOLDER}}</div></div><p class="c4l-spacer">&nbsp;</p>`,
        text: "November 17th",
        docs: {
    ...
    },
    {
        ...
        code:
            ...
            ` aria-label="{{#gradingvalue}}"><span>{{#gradingvalue}}: </span>` +
    ...
    },
    {
        ...
        code:
            ...
            aria-label="{{#allpurposecard}}"><p>{{PLACEHOLDER}}</p></div><p class="c4l-spacer">&nbsp;</p>`,
        text:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus a posuere nibh, eu mollis lacus." +
            " Praesent dictum in velit sed dapibus." +
            " Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.",
    ...
    },
    {
        ...
        code:
            `<p class="c4l-spacer">&nbsp;</p><div class="c4l-inline-group"><div class="c4lv-aiuseallowed {{VARIANTS}}"
             aria-label="{{#aiuseallowed}}">{{PLACEHOLDER}}</div></div><p class="c4l-spacer">&nbsp;</p>`,
    ...
    },
    {
        ...
        code:
            `<p class="c4l-spacer">&nbsp;</p><div class="c4l-inline-group"><div class="c4lv-aiusenotallowed {{VARIANTS}}"
             aria-label="{{#aiusenotallowed}}">{{PLACEHOLDER}}</div></div><p class="c4l-spacer">&nbsp;</p>`,
    ...
    },
    {
        ...
        code:
            `<p class="c4l-spacer">&nbsp;</p><div class="c4l-inline-group"><div class="c4lv-aiusereported {{VARIANTS}}"
             aria-label="{{#aiusereported}}">{{PLACEHOLDER}}</div></div><p class="c4l-spacer">&nbsp;</p>`,
